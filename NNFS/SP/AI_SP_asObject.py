...
for l_rate in range(1, 20):
    ...
    if train_AI:
        ...
        # Add layers
        model.add(Layer_Dense(2, 64, weight_regularizer_l1=1e-4, bias_regularizer_l1=1e-4))
        ...
        model.set(
            ...
            optimizer=Optimizer_Adam(learning_rate=learning_rate, decay=5e-6),
...
if model.accuracy > 0.975:
    if save_Layers:
        ...
        print(f'Model saved - new accuracy based off validation test: {model.accuracy:.3f}')

if load_Layers:
    with open("AI_SP_model.pk", 'rb') as fti1:
