...
if following_book:
    X_training, y_training = spiral_data(samples=100, classes =3)
else:
    readTrainingData()
...
if train_AI:
    ...
    for epoch in range(10001):
        ...
        data_loss = loss_activation.forward(dense2.output, y_training)
        ...
        # Backward pass
        loss_activation.backward(loss_activation.output, y_training)
    ...
    # Perform a forward pass through the activation/loss function
    # takes the output from second dense layer here and returns loss
